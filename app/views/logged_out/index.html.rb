    ...
    row(class:'blue-container full-width body-copy') {
      column('small-12 medium-9 medium-centered large-7 large-centered') {
        ...
        ul(class:'no-list-styling') {
          li {text "– A new way to find out what’s going on up there in your own mixture of cells."}
          li {text "– A new way to know how your circuits can amp up your life + work."}
          li {text "– Oh. It might help you improve your world by changing how you view your world with the brain in mind."}
        }
        br
